            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="mail-content">
                        ...
                        <li id="mailPhone"></li>
                        <li class="mail-title">Şirket Adı:</li>
                        <li id="companyName"></li>
                        <li class="mail-title">Şirketteki Görevi:</li>
                        <li id="roleCompany"></li>
                        <li class="mail-title">Şirket Faaliyet Alanı:</li>
                        <li id="companyActivity"></li>
                        <li class="mail-title">Ulaşma Sebebi:</li>
                        <li id="forWhat"></li>
...
@section("extraJs")
    ...
    <script>
        ...
        function readMail(route, id) {
            ...
            let roleCompany = document.getElementById("roleCompany");
            let companyActivity = document.getElementById("companyActivity");
            let forWhat = document.getElementById("forWhat");
            ...
            axios.post(route, {}, {
                ...
                .then(response => {
                    if (response.data.status === "success") {
                        ...
                        companyName.innerHTML = response.data.mail["companyName"]
                        roleCompany.innerHTML = response.data.mail["roleCompany"]
                        companyActivity.innerHTML = response.data.mail["companyActivity"]
                        forWhat.innerHTML = response.data.mail["forWhat"]
