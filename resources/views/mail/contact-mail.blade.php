...
<div class="container">
    ...
    <div class="content">
        <div class="info">
            ...
            <p><strong>Şirket Adı:</strong> {{ $data['companyName'] }}</p>
            <p><strong>Şirketteki Görevi:</strong> {{ $data['roleCompany'] }}</p>
            <p><strong>Şirket Faaliyet Alanı:</strong> {{ $data['companyActivity'] }}</p>
            <p><strong>Ulaşma Sebebi:</strong> {{ $data['forWhat'] }}</p>
